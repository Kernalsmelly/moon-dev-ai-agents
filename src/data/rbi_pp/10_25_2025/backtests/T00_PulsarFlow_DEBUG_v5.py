                ...
                if div and swing_low is not None and close > swing_low:
                    ...
                    if risk > 0:
                        ...
                        if size > 0:
                            ...
                            print(f"🌙 Moon Dev: LONG entry signal at {entry_price:.2f}, size {size}, intended SL {sl:.2f}, TP {intended_tp:.2f} 🚀")
                            return
                else:
                ...
                if div and swing_high is not None and close < swing_high:
                    ...
                    if risk > 0:
                        ...
                        if size > 0:
                            ...
                            self.sell(size=size)
                            intended_tp = entry_price - self.rr_ratio * risk
                            print(f"🌙 Moon Dev: SHORT entry signal at {entry_price:.2f}, size {size}, intended SL {sl:.2f}, TP {intended_tp:.2f} 📉")
                            return
                else:
