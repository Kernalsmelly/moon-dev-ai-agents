    ...
    def next(self):
        ...
        if not self.position:
            ...
            if close <= lower and rsi < self.rsi_oversold and close > sma200:
                ...
                print(f"🌙 Moon Dev: Entering Long at {close}, Size: {size}, SL: {sl:.2f}, TP: {tp:.2f}, RSI: {rsi:.2f}, ATR: {atr:.2f} 🚀")
            ...
            # Short entry
                ...
                self.position.entry_time = current_time
                print(f"🌙 Moon Dev: Entering Short at {close}, Size: {size}, SL: {sl:.2f}, TP: {tp:.2f}, RSI: {rsi:.2f}, ATR: {atr:.2f} ✨")
