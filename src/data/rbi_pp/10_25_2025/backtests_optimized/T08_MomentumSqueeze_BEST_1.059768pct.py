...
class MomentumSqueeze(Strategy):
    ...
    def next(self):
        ...
        if (self.last_long_breakout >= 0 and bars_since_long <= 5 and bull_cross and vol_rising and trend_up and rsi_long_ok and adx_strong and
        ...
        if (self.last_short_breakout >= 0 and bars_since_short <= 5 and bear_cross and vol_rising and trend_down and rsi_short_ok and adx_strong and
