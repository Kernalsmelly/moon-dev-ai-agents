            ...
            with open(SIGNALS_IN, "r", encoding="utf-8") as fh:
                ...
                while True:
                    ...
                    pending[signal_key] = {
                        "mint": str(mint),
                        "signal_ts": ts,
                        "signal_run_id": str(sig.get("run_id") or "").strip() or None,
        ...
        for signal_key, info in list(pending.items()):
            ...
            for h in HORIZONS_S:
                ...
                append_outcome({
                    ...
                    "signal_source": m.get("source"),
                    "pair_age_min0": m.get("pair_age_min"),
                    "mover_pattern0": m.get("mover_pattern"),
                    "signal_profile0": m.get("signal_profile"),
                    "supply_ui": supply_ui,
                    "liq0": liq0,
                    "mcap0": mcap0,
                    "marketcap0": mcap0,
